...
def save_train_val_test(x_train, y_train, x_val, y_val, x_test, y_test):
    np.save(dir_model+r'/CT_2D_unet_dataset/total/x_train.npy', x_train)
    np.save(dir_model+r'/CT_2D_unet_dataset/total/y_train.npy', y_train)
    np.save(dir_model+r'/CT_2D_unet_dataset/total/x_val.npy', x_val)
    np.save(dir_model+r'/CT_2D_unet_dataset/total/y_val.npy', y_val)
    np.save(dir_model+r'/CT_2D_unet_dataset/total/x_test.npy', x_test)
    np.save(dir_model+r'/CT_2D_unet_dataset/total/y_test.npy', y_test)

def load_train_val_test():
    x_train = np.load(dir_model+r'/CT_2D_unet_dataset/total/x_train.npy')
    y_train = np.load(dir_model+r'/CT_2D_unet_dataset/total/y_train.npy')
    x_val = np.load(dir_model+r'/CT_2D_unet_dataset/total/x_val.npy')
    y_val = np.load(dir_model+r'/CT_2D_unet_dataset/total/y_val.npy')
    x_test = np.load(dir_model+r'/CT_2D_unet_dataset/total/x_test.npy')
    y_test = np.load(dir_model+r'/CT_2D_unet_dataset/total/y_test.npy')
    return x_train, y_train, x_val, y_val, x_test, y_test

def create_train_val_test(path):

    if os.path.exists(dir_model+r'/CT_2D_unet_dataset/total/x_train.npy'):
...
def delete_no_image(x, y, mode):
    ...
    np.save(dir_model+r'/CT_2D_unet_dataset/index/{}_inx.npy'.format(mode), np_zero_inx)
    return x, y
...
def additional_process(x_train, y_train, x_val, y_val, x_test, y_test):
